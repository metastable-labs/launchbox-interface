  ...
  return (
    <div
      className={classNames(
        "py-[3px] px-1 flex items-center rounded-[10px] relative w-7 h-4 transition-colors duration-300 cursor-pointer",
        {
    ...
    <div className="self-stretch flex flex-col items-start justify-center gap-1 pb-3 border-b border-b-primary-50">
      <div className="flex items-center justify-center gap-2">
        <SwitchIcon
          ...
          network={network}
        />
        <span className="text-primary-150 text-sm font-medium tracking-[-0.084px]">
          {title}
        </span>
      </div>

      <p className="text-[10px] leading-[16px] text-primary-250">
        {instruction}
      </p>
    </div>
  );
