  ...
  return (
    <div className="px-4 rounded-lg border border-primary-50 bg-white flex flex-col self-stretch gap-2">
      ...
      <div className="flex flex-col items-stretch justify-center gap-5 self-stretch pb-4">
        <CustomizeInput
          handleChange={(value) => handleChange("heroTitle", value)}
          label="Hero title"
          placeholder="Enter hero title"
          instruction="This is a big hero text"
          value={heroTitle}
        />

        <CustomizeInput
          handleChange={(value) => handleChange("heroDescription", value)}
          label="Description"
        ...
        <div className="flex flex-col items-stretch gap-4">
          <span className="text-primary-2000 text-xs font-medium">
            Hero Image
          </span>
