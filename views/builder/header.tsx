  ...
  return (
    <header className="fixed w-screen h-16 z-30 flex justify-between items-center px-5 md:px-8 border-b border-b-primary-50 bg-white">
      <div className="flex items-center justify-center gap-4">
        <LBClickAnimation
          onClick={hideCoustomize}
          className="p-2 border border-primary-1950 shadow-table-cta bg-white rounded-lg flex, items-center justify-center"
        >
        ...
        {displays.map(({ icon, onClick, type }, index) => (
          <LBClickAnimation
            ...
            className={classNames(
              "p-2 border border-primary-1950 shadow-table-cta rounded-lg flex, items-center justify-center transition-colors duration-300 ease-in-out",
              {
      ...
      <div className="flex items-center justify-center gap-2">
        ...
        {actions.map(({ actionText, onClick, active }, index) => (
          <LBClickAnimation
            ...
            onClick={onClick}
            className={classNames(
              "px-4 py-2.5 shadow-table-cta rounded-lg flex items-center justify-center font-semibold transition-colors duration-300 ease-in-out",
              {
                "border border-primary-1950 bg-white text-primary-2000":
                  index === 0 && active,
                "border border-primary-950 text-primary-2050 bg-white pointer-events-none":
                  index === 0 && !active,
                "border border-primary-2100 bg-primary-2100 text-white":
                  index === 1 && active,
                "border border-primary-950 text-primary-2050 bg-primary-2150 pointer-events-none":
                  index === 1 && !active,
              }
            )}
          >
