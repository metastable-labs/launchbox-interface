...
const ClickTabs = ({ tabTexts, tab, setTab }: IClickTabs) => {
  ...
  return (
    <div className={classNames('flex items-center justify-start max-w-fit relative font-Clash-Display', { 'gap-2': tabTexts.length > 1 })}>
      ...
      <motion.div
        ...
        className="absolute bottom-0 left-0 h-[3px] bg-primary-3350"
      />
    </div>
  );
};
