...
const LBSecondarySelect = ({ defaultValue, onClick, options, text, disabled, label }: ILBSecondarySelect) => {
  ...
  return (
    <div className="relative">
      <LBClickAnimation
        ...
        <span className="text-sm font-semibold text-primary-2000">{selectedOption?.text}</span>
      </LBClickAnimation>
