  ...
  <LBContainer>
    <section
      className={classNames('', {
        'pt-[128px] md:pt-[160px] flex flex-col md:flex-row items-center justify-between gap-20 pb-[72px] md:px-12 lg:px-7 xl:px-[60px]': !isBuilder,
        'py-[45px] flex items-center justify-between gap-[50.111px] w-full': isBuilder && isDesktop,
        'py-[45px] flex flex-col items-stretch justify-center gap-20 -mx-20 px-5': isBuilder && isMobile,
      })}>
      <div
        ...
        <div
          ...
          <h1
            className={classNames('text-primary-1650 font-semibold', {
              ...
              'text-[42.594px] leading-[51.113px] tracking-[-0.426px]': isBuilder && isDesktop,
          ...
          <p
            className={classNames('text-primary-1700', {
              ...
              'text-[11.275px] leading-[16.913px] max-w-[296px]': isBuilder && isDesktop,
        ...
        <div
          className={classNames('', {
            'flex flex-col md:flex-row items-stretch md:items-center justify-center gap-4 w-full md:w-auto': !isBuilder,
            'flex items-center justify-start gap-[10.02px] w-full': isBuilder && isDesktop,
            'flex flex-col items-stretch justify-center gap-4 w-full': isBuilder && isMobile,
          })}>
          <LandingLink link={buyLink} text={heroPrimaryButtonText} color={primaryColor} isBuilder={isBuilder} />
          <LandingLink link={chainExplorerLink} text={heroSecondaryButtonText} color={secondaryColor} variant="secondary" isBuilder={isBuilder} />
        </div>
      </div>
