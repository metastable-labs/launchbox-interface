        ...
        >
          ...
          >
            ...
            <p className="flex flex-col self-stretch gap-1 text-center">
              <p className="text-primary-150 text-sm tracking-[-0.084px] font-medium max-w-[332px] text-center">
                Choose a file or drag & drop it here.
              </p>
              <span className="text-primary-750 text-xs font-normal">
                SVG, PNG, JPEG formats up to 5MB
              </span>
            </p>

            <LBClickAnimation
              onClick={handleButtonClick}
              className="px-4 py-[6px] flex items-center justify-center shadow-fade-dark rounded-lg bg-white border border-primary-50"
            >
              <span className="text-sm tracking-[-0.084px] text-primary-250 font-medium text-center px-1">
                Browse File
              </span>
            </LBClickAnimation>
          </div>
